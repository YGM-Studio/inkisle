...
- `published` defaults to `true`; `published: false` excludes the entry from production output.
- `draft: true` remains supported for draft content and is also excluded from production output.
